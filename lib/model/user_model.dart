...
class CharactersInfo {
  ...
  factory CharactersInfo.fromJson(Map<String, dynamic> json) => CharactersInfo(
    ...
    characters: json["results"] == null ? [] : List<Character>.from(json["results"]!.map((x) => Character.fromJson(x))),
  );

  Map<String, dynamic> toJson() => {
    "info": info?.toJson(),
    "results": characters == null ? [] : List<dynamic>.from(characters!.map((x) => x.toJson())),
  };
}
